...
ANOVA ima tri pretpostavke, a to su: nezavisnost opažanja (dizajn istraživanja), normalnost distribucije unutar svake grupe (ili dovoljno velik n), homogenost varijance (jednake varijance u svim grupama).
...
Cohen (1988) je predložio sljedeće smjernice:
