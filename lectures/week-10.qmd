...
Ključne kategoričke varijable su `age_group` (četiri kategorije: 18-29, 30-44, 45-59, 60+) i `media_type` (šest kategorija: streaming, TV, web portal, radio, tisak, podcast). Temeljno pitanje za upravu glasi — postoji li veza između dobi i preferiranog medija? I ako postoji, koliko je jaka?
...
Hi-kvadrat statistika mjeri koliko se vaši opaženi podaci razlikuju od onoga što biste očekivali da je nulta hipoteza istinita. Formula je sljedeća:
...
Hi-kvadrat test je aproksimacija, i da bi ta aproksimacija bila pouzdana, sve očekivane frekvencije moraju biti dovoljno velike. Konvencija kaže: barem 5 u svakoj ćeliji.
...
Standardizirani (Pearsonov) rezidual za svaku ćeliju računa se ovako:
...
Fisherov test za 2×2 tablice automatski računa odds ratio, odnosno omjer šansi. To je prirodna mjera veličine učinka za binarne ishode i odgovara na pitanje: koliko su šanse za konverziju veće uz direktni CTA nego uz indirektni?
...
McNemarov test koristite kad imate iste ispitanike mjerene dva puta na istoj binarnoj varijabli. Primjeri iz komunikologije: preferencija medija prije i poslije kampanje, stav prema brandu prije i poslije izlaganja reklami, izbor komunikacijskog kanala prije i poslije redizajna. Ključno je da su podaci upareni — isti ljudi, dva mjerenja.
:::
